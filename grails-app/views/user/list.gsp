                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="registrationDate" title="${message(code: 'user.registrationDate.label', default: 'Registration Date')}" />
                    ...
                    <g:each in="${userInstanceList}" status="i" var="userInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td><g:formatDate date="${userInstance.registrationDate}" /></td>
