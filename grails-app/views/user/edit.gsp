...
<%@ page import="gtugio.domain.User" %>
<html>
    <head>
                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="nickname"><g:message code="user.nickname.label" default="Nickname" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'nickname', 'errors')}">
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: userInstance, field: 'role', 'errors')}">
                                    <g:select name="role" from="${gtugio.configuration.auth.Role?.values()}" value="${userInstance?.role}"  />
                                </td>
                            </tr>
