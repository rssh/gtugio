                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="detailedDescription" title="${message(code: 'project.detailedDescription.label', default: 'Detailed Description')}" />
                        
                            <g:sortableColumn property="icon" title="${message(code: 'project.icon.label', default: 'Icon')}" />
                    ...
                    <g:each in="${projectInstanceList}" status="i" var="projectInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>${fieldValue(bean: projectInstance, field: "detailedDescription")}</td>
                        
                            <td>${fieldValue(bean: projectInstance, field: "icon")}</td>
